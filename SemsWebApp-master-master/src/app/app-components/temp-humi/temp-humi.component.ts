...
export class TempHumiComponent implements OnInit, AfterViewInit, AfterContentChecked {
  ...
  updateMonthlyPage() : void {
    ...
    this.tempTableMonthlyLabels= this.tempTableMonthlyLabels.concat(this.chartMonthlyLabels);

    this.humiTableMonthlyLabels = [];
    this.humiTableMonthlyLabels.push("습도계");
    this.humiTableMonthlyLabels= this.humiTableMonthlyLabels.concat(this.chartMonthlyLabels);
    ...
    this.semsService.getWeatherSummary("MONTHLY", format(this.startMonthlyDate, 'yyyy-MM-dd'), format(this.endMonthlyDate, 'yyyy-MM-dd'))
      ...
      for (let i = 0; i < apiData.length; i++) {
        if (apiData[i].insName.includes('Temp')) {
      ...
      this.tempTableMonthlyData = this.onTestUtil.syncWeatherGridData(this.chartMonthlyLabels, tempApiData, "temp", this.tempBarchartMonthly, 'yy-MM', undefined, undefined, this.site);
      this.humiTableMonthlyData = this.onTestUtil.syncWeatherGridData(this.chartMonthlyLabels, humidityApiData, "humidity", this.humiBarchartMonthly, 'yy-MM', undefined, undefined, this.site);
    })
  ...
  updateDailyPage() : void {
    ...
    this.tempTableDailyLabels= this.tempTableDailyLabels.concat(this.chartDailyLabels);

    this.humiTableDailyLabels = [];
    this.humiTableDailyLabels.push("습도계");
    this.humiTableDailyLabels= this.humiTableDailyLabels.concat(this.chartDailyLabels);
    ...
    this.semsService.getWeatherSummary("DAILY", format(this.startDailyDate, 'yyyy-MM-dd'), format(this.endDailyDate, 'yyyy-MM-dd'))
      ...
      this.tempTableDailyData = this.onTestUtil.syncWeatherGridData(this.chartDailyLabels, tempApiData, "temp", this.tempBarchartDaily, 'MM-dd', undefined, undefined, this.site);
      this.humiTableDailyData = this.onTestUtil.syncWeatherGridData(this.chartDailyLabels, humidityApiData, "humidity", this.humiBarchartDaily, 'MM-dd', undefined, undefined, this.site);
    })
  }
  ...
  updateHourlyPage() : void {
    ...
    this.tempTableTimeLabels= this.tempTableTimeLabels.concat(this.chartTimeLabels);

    this.humiTableTimeLabels = [];
    this.humiTableTimeLabels.push("습도계");
    this.humiTableTimeLabels= this.humiTableTimeLabels.concat(this.chartTimeLabels);
    ...
    this.semsService.getWeatherSummary("HOURLY", format(dateParam, 'yyyy-MM-dd'), format(dateParam.setDate(this.timeDate.getDate() + 1), 'yyyy-MM-dd'))
      ...
      this.tempTableTimeData = this.onTestUtil.syncWeatherGridData(this.chartTimeLabels, tempApiData, "temp", this.tempBarchartHourly, 'HH', 'hourly', undefined, this.site);
      this.humiTableTimeData = this.onTestUtil.syncWeatherGridData(this.chartTimeLabels, humidityApiData, "humidity", this.humiBarchartHourly, 'HH', 'hourly', undefined, this.site);
    })
  }
