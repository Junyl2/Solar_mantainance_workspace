...
export class SemsService {
  ...
  getSite(): any {
    ...
    const result = this.http
      ...
      .pipe(catchError(this.handleError('getSite', [])));
  ...
  getFacilities(): any {
    ...
    const result = this.http
      .get<Invertor[]>(this.SEMS_REST_API_SERVER + api)
      .pipe(catchError(this.handleError('get-facility', [])));
  ...
  getSiteMapImage(): any {
    ...
    const result = this.http
      .get<Invertor[]>(this.SEMS_REST_API_SERVER + api)
      .pipe(catchError(this.handleError('getSiteMapImage', [])));

    return result;
  }

  getWeatherInvertorList(
    startDate?: Date,
    endDate?: Date
  ): Observable<Facility[]> {
    ...
    const result = this.http
      ...
      .pipe(catchError(this.handleError('getWeatherInvertorList', [])));
  ...
  downloadWeatherData(
    ...
    let api = `/weather/history/data/download?filter=dateTime=ge='${
      startDate.toISOString().split('.')[0]
    }';dateTime=le='${endDate.toISOString().split('.')[0]}'`;
  ...
  downloadInvertorData(
    ...
    endDate: Date,
    invertors: Invertor[],
    invertorSelect: InvertorSelect
  ) {
    endDate = moment(endDate).add(1, 'days').toDate();
    let api = `/invertor/data/download?filter=dateTime=ge='${
      startDate.toISOString().split('.')[0]
    }';dateTime=le='${endDate.toISOString().split('.')[0]}'`;
    let query = null;
  ...
  downloadPvData(
    ...
    endDate = moment(endDate).add(1, 'days').toDate();
    let api = `/pv/history/data/download?filter=dateTime=ge='${
      startDate.toISOString().split('.')[0]
    }';dateTime=le='${endDate.toISOString().split('.')[0]}'`;
    let query = null;
  ...
  getAccount(account: string): Observable<any> {
    ...
    const result = this.http
      ...
      .pipe(catchError(this.handleError(`getAccount`, [])));
  ...
  getInvertorDataByDatetime(datetime: string) {
    ...
    const result = this.http.get<any>(`${this.REST_API_SERVER}${api}`).pipe(
  ...
  getInvertorStatGeneration(today?: Date, api?: any) {
    ...
    const result = this.http
      ...
      .pipe(catchError(this.handleError('getInvertorStatGeneration')));

    return result;
  }

  getInvertorErrorList(
    startDate?: Date,
    endDate?: Date,
    offset: Number = 0,
    pageSize: Number = 10
    ...
    if (startDate != null && endDate != null) {
      api = `${api}&filter=message.id!=0;dateTime=ge='${
        startDate.toISOString().split('.')[0]
      }';dateTime=le='${endDate.toISOString().split('.')[0]}'`;
    } else {
  ...
  getWeatherStatRadiation(today?: Date) {
    ...
    const result = this.http
      .get<any>(`${this.REST_API_SERVER}${api}`)
      .pipe(catchError(this.handleError('getWeatherStatRadiation')));
  ...
  getModuleGenerationInvInfo(insNum: number): any {
    ...
    const result = this.http
      .get<Invertor[]>(this.SEMS_REST_API_SERVER + api)
      .pipe(catchError(this.handleError('moduleGenerationInvInfo', [])));
  ...
  getModuleGenerationPvInfo(): any {
    ...
    const result = this.http
      .get<Invertor[]>(this.SEMS_REST_API_SERVER + api)
      .pipe(catchError(this.handleError('moduleGenerationPvInfo', [])));
  ...
  getModuleGenerationOptInfo(insNum: number): any {
    ...
    const result = this.http
      .get<Invertor[]>(this.SEMS_REST_API_SERVER + api)
      .pipe(catchError(this.handleError('moduleGenerationOptInfo', [])));

    return result;
  }

  getModuleGenerationDetailInfo(
    gbn: string,
    insNum: number,
    startDate: string,
    endDate: string
  ...
  getAnalyzeEnvironmentInfo(
    ...
    const result = this.http
      .get<Invertor[]>(this.SEMS_REST_API_SERVER + api)
      .pipe(catchError(this.handleError('analyzeEnvironmentInfo', [])));
  ...
  getAnalyzeTemperatureInvList(): any {
    ...
    const result = this.http
      .get<Invertor[]>(this.SEMS_REST_API_SERVER + api)
      .pipe(catchError(this.handleError('analyzeTemperatureInvList', [])));
  ...
  getAnalyzeTemperatureInfo(
    ...
    const result = this.http
      .get<Invertor[]>(this.SEMS_REST_API_SERVER + api)
      .pipe(catchError(this.handleError('analyzeTemperatureInfo', [])));
  ...
  getAnalyzePrInfo(gbn: string, startDate: string, endDate: string): any {
    ...
    const result = this.http
      .get<Invertor[]>(this.SEMS_REST_API_SERVER + api)
      .pipe(catchError(this.handleError('analyzePrInfo', [])));
  ...
  getAnalyzeUseRateInfo(gbn: string, startDate: string, endDate: string): any {
    ...
    const result = this.http
      .get<Invertor[]>(this.SEMS_REST_API_SERVER + api)
      .pipe(catchError(this.handleError('analyzeUseRateInfo', [])));
